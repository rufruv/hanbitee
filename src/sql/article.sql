...
INSERT INTO Article(art_seq, id, title, contents, regdate, read_count)
VALUES(art_seq.nextval, '김유신', '2nd 제목', '제목-2-내용-2', '2017-02-17', '1000000');
INSERT INTO Article(art_seq, id, title, contents, regdate, read_count)
VALUES(art_seq.nextval, '이순신', '3rd 제목', '제목-3-내용-3', '2017-02-17', '1000000');
INSERT INTO Article(art_seq, id, title, contents, regdate, read_count)
...
SELECT * FROM Article;
-- READ SOME
SELECT * FROM Article WHERE regdate='2017-02-15';
-- READ ONE
