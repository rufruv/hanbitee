...
<table class="table_default margin_center text_center" style="width:50%; height:180px; margin-top:30px">
	<tr>
		<th class="text_center" style="width:5%; vertical-align:middle;">SEQ</th>
		<th class="text_center" style="width:55%; vertical-align:middle;">TITLE</th>
		<th class="text_center" style="width:15%; vertical-align:middle;">ID</th>
		<th class="text_center" style="width:15%; vertical-align:middle;">REGDATE</th>
		<th class="text_center" style="width:10%; vertical-align:middle;">READCOUNT</th>
	</tr>
	<tr>
		<td>100</td>
		<td>title_001</td>
